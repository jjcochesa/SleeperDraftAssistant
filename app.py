...
def _build_rankings_df(
    ...
    for p in players:
        ...
        rows.append({
            ...
            "DP Rec":    dp_rec,
            # hidden detail cols
            "_goals":    p.get("goals", 0),
            "_assists":  p.get("assists", 0),
            "_sot":      p.get("shots_on_target", 0),
            "_kp":       p.get("key_passes", 0),
            "_drb":      p.get("dribbles", 0),
            "_acnc":     p.get("accurate_crosses", 0),
            "_aer":      p.get("aerials_won", 0),
            "_cs":       p.get("clean_sheets", 0),
            "_saves":    p.get("saves", 0),
            "_hcs":      p.get("high_claims", 0),
            "_sm":       p.get("smothers", 0),
            "_tkl":      p.get("tackles_won", 0),
            "_int":      p.get("interceptions", 0),
